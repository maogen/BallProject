...
public class ImageUtils {
	...
	public static void compareImage(String imgPath1, String imgPath2) {
		...
		String baifen = "";
		try {
			baifen = ((Double.parseDouble(xiangsi + "")
					/ Double.parseDouble((busi + xiangsi) + "")) + "");
	...
	@Test
	public void test() {
		ImageUtils.compareImage("D:\\360\\1.jpg", "D:\\360\\2.jpg");
		ImageUtils.compareImage("D:\\360\\1.jpg", "D:\\360\\3.jpg");
	}
}
